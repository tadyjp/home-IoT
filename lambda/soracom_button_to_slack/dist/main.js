...
// src/entity/Event.ts
var EventRaw = class {
  constructor(clickType, clickTypeName, batteryLevel, binaryParserEnabled) {
    this.clickType = clickType;
    this.clickTypeName = clickTypeName;
    this.batteryLevel = batteryLevel;
    this.binaryParserEnabled = binaryParserEnabled;
  }
  printMarkdown() {
...
var Event = class {
  constructor(imei, raw) {
    this.imei = imei;
    this.raw = raw;
  }
};

// src/application/Notification.ts
var Notification = class {
  constructor(client, mailboxButtonIMEI2) {
    this.client = client;
    this.mailboxButtonIMEI = mailboxButtonIMEI2;
  }
  async execute(event) {
...
// src/application/IMessageClient.ts
var IMessageClient = class {
};

// src/infrastructure/SlackClient.ts
var SlackClient = class extends IMessageClient {
...
var mailboxButtonIMEI = process.env.MAINBOX_BUTTON_IMEI;
async function handler(event) {
  ...
  for (const record of event.Records) {
    ...
    if (body.imei === mailboxButtonIMEI) {
      const event2 = new Event(body.imei, new EventRaw(body.payloads.clickType, body.payloads.clickTypeName, body.payloads.batteryLevel, body.payloads.binaryParserEnabled));
      await notification.execute(event2);
    }
  }
}
